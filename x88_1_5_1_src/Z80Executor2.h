...
#define M_Calc_ADD_8(btDst, btSrc) { \
	M_UpdateRegF( \
		...
		CZ80Data::m_abtFlags_ADD_8[0][btDst][btSrc]); \
...
#define M_Calc_ADC_8(btDst, btSrc) { \
	...
	M_UpdateRegF( \
		C_FLAG | Z_FLAG | P_V_FLAG | S_FLAG | N_FLAG | H_FLAG, \
		CZ80Data::m_abtFlags_ADD_8[nCarry][btDst][btSrc]); \
...
#define M_Calc_SUB_8(btDst, btSrc) { \
	M_UpdateRegF( \
		C_FLAG | Z_FLAG | P_V_FLAG | S_FLAG | N_FLAG | H_FLAG, \
		CZ80Data::m_abtFlags_SUB_8[0][btDst][btSrc]); \
	btDst = uint8_t(btDst-btSrc); \
}
#else // Z80CFG_NOUSE_FLAGTBL
#define M_Calc_SUB_8(btDst, btSrc) { \
...
#define M_Calc_SBC_8(btDst, btSrc) { \
	...
	M_UpdateRegF( \
		C_FLAG | Z_FLAG | P_V_FLAG | S_FLAG | N_FLAG | H_FLAG, \
		CZ80Data::m_abtFlags_SUB_8[nCarry][btDst][btSrc]); \
	btDst = uint8_t(btDst-btSrc-nCarry); \
}
#else // Z80CFG_NOUSE_FLAGTBL
#define M_Calc_SBC_8(btDst, btSrc) { \
...
#define M_Calc_BIT_b(btB, btData) { \
	M_UpdateRegF( \
		Z_FLAG | P_V_FLAG | S_FLAG | N_FLAG | H_FLAG, \
		CZ80Data::m_abtFlags_BIT_b[btB][btData]); \
}
#else // Z80CFG_NOUSE_FLAGTBL
...
#define M_Calc_DAA(btData) { \
	...
	M_UpdateRegF( \
		...
		CZ80Data::m_abtFlags_DAA[nFlags][btData]); \
	btData = CZ80Data::m_abtResult_DAA[nFlags][btData]; \
}
#else // Z80CFG_NOUSE_FLAGTBL
#define M_Calc_DAA(btData) { \
