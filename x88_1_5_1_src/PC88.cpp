...
void CPC88::Initialize() {
	...
	if ((fpt = SysFileOpen("pc88.rom")) != NULL) {
		bExistNBasic = true;
		...
		if (((fpt = SysFileOpen("n88.rom")) != NULL) ||
			((fpt = SysFileOpen("8801-n88.rom")) != NULL))
		{
			FileRead(Z80Main().GetN88BasicRomPtr(), 0x8000, fpt);
			fclose(fpt);
		}
		if (((fpt = SysFileOpen("n80.rom")) != NULL) ||
			((fpt = SysFileOpen("8801-n80.rom")) != NULL))
		{
			bExistNBasic = true;
			FileRead(Z80Main().GetNBasicRomPtr(), 0x8000, fpt);
			fclose(fpt);
		}
		if (((fpt = SysFileOpen("n88_0.rom")) != NULL) ||
			((fpt = SysFileOpen("8801-4th.rom")) != NULL))
		{
			FileRead(Z80Main().GetIERomPtr(0), 0x2000, fpt);
			fclose(fpt);
		}
		if ((fpt = SysFileOpen("n88_1.rom")) != NULL) {
			FileRead(Z80Main().GetIERomPtr(1), 0x2000, fpt);
			fclose(fpt);
		}
		if ((fpt = SysFileOpen("n88_2.rom")) != NULL) {
			FileRead(Z80Main().GetIERomPtr(2), 0x2000, fpt);
			fclose(fpt);
		}
		if ((fpt = SysFileOpen("n88_3.rom")) != NULL) {
			FileRead(Z80Main().GetIERomPtr(3), 0x2000, fpt);
			fclose(fpt);
		}
		if ((fpt = SysFileOpen("disk.rom")) != NULL) {
			FileRead(Z80Sub().GetSubRomPtr(), 0x2000, fpt);
			fclose(fpt);
		}
	}
	if (((fpt = SysFileOpen("n80_2.rom")) != NULL)) {
	...
	} else if ((fpt = SysFileOpen("pc-8801.fon")) != NULL) {
		FileRead(Z80Main().GetKanjiRomPtr(0)+0x1000, 0x800, fpt);
		fclose(fpt);
	...
	if ((fpt = SysFileOpen("kanji2.rom")) != NULL) {
	...
	if ((fpt = SysFileOpen("font80sr.rom")) != NULL) {
		FileRead(Z80Main().GetFont80SRRomPtr(), 0x2000, fpt);
		fclose(fpt);
	} else if ((fpt = SysFileOpen("hirafont.rom")) != NULL) {
	...
	memcpy(Z80Main().GetOptionFontRomPtr(),
		Z80Main().GetKanjiRomPtr(0)+0x1000,
		0x800);
	if ((fpt = SysFileOpen("optfont.rom")) != NULL) {
